...
**v1.0.0** binds SDL **3.5.0** for **Delphi 11+ Win64**. Free Pascal / Lazarus and macOS / Android / iOS are planned later.
...
First public release: **v1.0.0**. Header pin: **SDL 3.5.0**. Supported target: **Delphi 11+ Win64**.
